...
# Starting the installation
	...
	9. Now, we install the base system along with the development (programming related softwares) packages. So use the following command to do the same (This will take a while depending on Internet):
		...
		pacstrap /mnt base base-devel python3 python2 zsh zsh-completions zsh-syntax-highlighting zsh-autosuggestions intel-ucode ttf-noto ttf-inconsolata ttf-dejavu sudo vim neovim clang xorg xorg-xinit xf86-video-intel cmake git --needed
